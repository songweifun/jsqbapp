...
var AddLibraryModalComponent = (function () {
    ...
    function AddLibraryModalComponent(modalService, systemService, modalService2, fb) {
        ...
        this.formModel = fb.group({
            ...
            app_description: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(10)]],
        ...
        if (this.ipMapId) {
            ...
            this.systemService.getOneLibrary(this.ipMapId).subscribe(function (data) {
                ...
                _this.formModel = _this.fb.group({
                    ...
                    app_description: [data.app_description, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(10)]],
