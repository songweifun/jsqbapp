...
var LibraryStatisticsComponent = (function () {
    ...
    LibraryStatisticsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.systemService.getOrderStatisticsBySchool(function (data) {
            _this.options = {
                single: data,
                multi: [],
                view: [700, 400],
        ...
        this.systemService.getResourceStatisticsBySchool(function (data) {
...
var RequestStatisticsComponent = (function () {
    ...
    RequestStatisticsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.systemService.getRequstStatisticsByIpTop10(function (data) {
        ...
        this.systemService.getRequestStatisticsByMapNameTop10(function (data) {
