...
var AddLibraryModalComponent = (function () {
    ...
    AddLibraryModalComponent.prototype.open = function (content) {
        ...
        if (this.ipMapId) {
            // alert(111)
            this.systemService.getOneLibrary(this.ipMapId, function (data) {
                _this.formModel = _this.fb.group({
                    app_id: [data.user_name, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].minLength(6)]],
                    secret: _this.fb.group({
                        app_secret: [data.password, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].minLength(6)],
                        c_app_secret: [data.password]
                    }, {
                        validator: __WEBPACK_IMPORTED_MODULE_5__validator_validators__["a" /* equalValidator */] //这么用
                    }),
                    school_id: [data.library_id, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].required]],
...
], AddLibraryModalComponent.prototype, "schools", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_services_api_url_service__ = __webpack_require__("../../../../../src/app/shared/services/api-url.service.ts");
...
var LibraryComponent = (function () {
    function LibraryComponent(appService, modalService, systemService, apiUrlService) {
    ...
    LibraryComponent.prototype.onDataChanged = function (event) {
        //console.log(event)
    ...
    LibraryComponent.prototype.change = function (event, id) {
        ...
        this.systemService.updateLibraryIsOpen(status, id, function () { }, function () { });
    };
    LibraryComponent.prototype.addLibrary = function (event) {
        var _this = this;
        this.systemService.addLibrary(event.formModel.value, function (data) {
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, '管理账户', '添加成功');
                ...
                _this.systemService.getLibrarys(function (data) {
                    _this.libraries = data.rows;
                }, function (err) { });
            }
            else {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '管理账户', data.msg);
                _this.modalService.alert(alertCfg);
            }
        }, function (err) { });
    };
    LibraryComponent.prototype.editLibray = function (event, id) {
        var _this = this;
        this.systemService.updateLibrary(event.formModel.value, id, function (data) {
            //console.log(data)
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, '管理账户', '修改成功');
                _this.modalService.alert(alertCfg);
                event.ref.close();
                // this.appService.pageRefreshEventEmitter.emit(this.transformPageData);//创建一个事件流发送传递过来的分页信息
                _this.systemService.getLibrarys(function (data) {
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '管理账户', '修改失败');
                _this.modalService.alert(alertCfg);
            }
        }, function (err) { });
    };
    LibraryComponent.prototype.deleteLibrary = function (id) {
        var _this = this;
        var confirmCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["c" /* ConfirmConfig */]('您确定要删除此账号吗？');
        this.modalService.confirm(confirmCfg).then(function (result) {
            _this.systemService.deleteLibrary(id, function (data) {
                if (data.errorCode === 0) {
                    var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, '管理账户', '删除成功');
                    _this.modalService.alert(alertCfg);
                    //this.appService.pageRefreshEventEmitter.emit(this.transformPageData);//创建一个事件流发送传递过来的分页信息
                    _this.systemService.getLibrarys(function (data) {
                        _this.libraries = data.rows;
                    ...
                    var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '管理账户', '删除失败');
                    _this.modalService.alert(alertCfg);
                }
            }, function (err) { });
        }, function (reason) {
...
/***/ "../../../../../src/app/layout/system/sip2-config/sip2-config.component.html":
/***/ (function(module, exports) {

module.exports = "<div [@routerTransition]>\n    <app-sip2-config-list [configs]=\"configs\" [transformPageData]=\"transformPageData\" ></app-sip2-config-list>\n    <app-http-pagination [url]=\"url\" [method]=\"'GET'\"  [pageList]=\"pageList\" (onDataChanged)=\"onDataChanged($event)\" ></app-http-pagination>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/layout/system/sip2-config/sip2-config.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/layout/system/sip2-config/sip2-config.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Sip2ConfigComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Sip2ConfigComponent = (function () {
    function Sip2ConfigComponent(apiUrlService) {
        this.apiUrlService = apiUrlService;
        this.pageList = [10, 15, 25, 35];
    ...
    Sip2ConfigComponent.prototype.ngOnInit = function () {
    };
    Sip2ConfigComponent.prototype.onDataChanged = function (event) {
    ...
    return Sip2ConfigComponent;
}());
Sip2ConfigComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-sip2-config',
        template: __webpack_require__("../../../../../src/app/layout/system/sip2-config/sip2-config.component.html"),
        styles: [__webpack_require__("../../../../../src/app/layout/system/sip2-config/sip2-config.component.scss")],
...
var _a;
//# sourceMappingURL=sip2-config.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sip2_config_sip2_config_component__ = __webpack_require__("../../../../../src/app/layout/system/sip2-config/sip2-config.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'sip2',
                component: __WEBPACK_IMPORTED_MODULE_4__sip2_config_sip2_config_component__["a" /* Sip2ConfigComponent */]
            },
        ]
    }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sip2_config_sip2_config_component__ = __webpack_require__("../../../../../src/app/layout/system/sip2-config/sip2-config.component.ts");
...
SystemModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__sip2_config_sip2_config_component__["a" /* Sip2ConfigComponent */]
        ]
    })
], SystemModule);
