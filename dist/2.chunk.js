...
var AddIpModalComponent = (function () {
    ...
    AddIpModalComponent.prototype.open = function (content) {
        ...
        if (this.ipMapId) {
            this.systemService.getOneIpMap(this.ipMapId, function (data) {
                //console.log(content)
...
var IpListComponent = (function () {
    ...
    IpListComponent.prototype.change = function ($event, id) {
        //alert($event);
        //alert(id)
        this.systemService.updateIsopen($event, id, function () { }, function () { });
    };
    IpListComponent.prototype.changeIsForbid = function ($event, id) {
        var _this = this;
        //alert(id)
        this.systemService.updateIsForbid($event, id, function (data) {
    ...
    IpListComponent.prototype.addIpMap = function (event, isBlack) {
        ...
        //console.log(event)
        var _this = this;
        this.systemService.addIpMap(event.formModel.value, isBlack, function (data) {
            if (data.errorCode === 0) {
    ...
    IpListComponent.prototype.editIpMap = function (event, id) {
        ...
        this.systemService.updateIpMap(event.formModel.value, id, function (data) {
            //console.log(data)
            if (data.errorCode === 0) {
    ...
    IpListComponent.prototype.deleteIpMap = function (id) {
        ...
        this.modalService.confirm(confirmCfg).then(function (result) {
            _this.systemService.deleteIpMap(id, function (data) {
                if (data.errorCode === 0) {
