...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ipmaping_routing_module__ = __webpack_require__("../../../../../src/app/layout/ipmaping/ipmaping-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ipmaping_component__ = __webpack_require__("../../../../../src/app/layout/ipmaping/ipmaping.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ips_map_ips_map_component__ = __webpack_require__("../../../../../src/app/layout/ipmaping/ips-map/ips-map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__my_component_components_ip_list_ip_list_component__ = __webpack_require__("../../../../../src/app/layout/my-component/components/ip-list/ip-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__my_component_components_add_ip_modal_add_ip_modal_component__ = __webpack_require__("../../../../../src/app/layout/my-component/components/add-ip-modal/add-ip-modal.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ip_white_ip_white_component__ = __webpack_require__("../../../../../src/app/layout/ipmaping/ip-white/ip-white.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ip_black_ip_black_component__ = __webpack_require__("../../../../../src/app/layout/ipmaping/ip-black/ip-black.component.ts");
...
IpmapingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__ipmaping_routing_module__["a" /* IpmapingRoutingModule */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__ipmaping_component__["a" /* IpmapingComponent */],
            __WEBPACK_IMPORTED_MODULE_10__ips_map_ips_map_component__["a" /* IpsMapComponent */],
            __WEBPACK_IMPORTED_MODULE_11__my_component_components_ip_list_ip_list_component__["a" /* IpListComponent */],
            __WEBPACK_IMPORTED_MODULE_12__my_component_components_add_ip_modal_add_ip_modal_component__["a" /* AddIpModalComponent */],
            __WEBPACK_IMPORTED_MODULE_13__ip_white_ip_white_component__["a" /* IpWhiteComponent */],
            __WEBPACK_IMPORTED_MODULE_14__ip_black_ip_black_component__["a" /* IpBlackComponent */]
        ]
    })
], IpmapingModule);
...
var AddIpModalComponent = (function () {
    ...
    function AddIpModalComponent(modalService, systemService, modalService2, fb) {
        ...
        this.formModel = fb.group({
            mapName: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
            ipRange: fb.group({
            ...
            isOpen: [1],
            daylimit: [100, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
            monthlimit: [1000, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]]
        });
    }
        ...
        if (this.ipMapId) {
            this.systemService.getOneIpMap(this.ipMapId).subscribe(function (data) {
                ...
                _this.formModel = _this.fb.group({
                    mapName: [data.map_name, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
                    ...
                    time: [{ year: year, month: month, day: day }, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
                    isOpen: [data.is_open],
                    daylimit: [data.daylimit, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
                    monthlimit: [data.monthlimit, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]]
                });
            });
        }
        //this.formMode
...
AddIpModalComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_5__shared_components_datepickerI18n_datepickerI18n__["b" /* DatepickerI18nType */], { provide: __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["e" /* NgbDatepickerI18n */], useClass: __WEBPACK_IMPORTED_MODULE_5__shared_components_datepickerI18n_datepickerI18n__["a" /* DatepickerI18n */] }]
    }),
    ...
    IpListComponent.prototype.addIpMap = function (event, isBlack) {
        ...
        this.systemService.addIpMap(event.formModel.value, isBlack).subscribe(function (data) {
            if (data.errorCode === 0) {
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3__shared_components_modal_modal_model__["c" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3__shared_components_modal_modal_model__["b" /* AlertType */].ERROR, 'IP映射', '添加失败');
                _this.modalService.alert(alertCfg);
            }
        });
    };
    IpListComponent.prototype.editIpMap = function (event, id) {
        ...
        this.systemService.updateIpMap(event.formModel.value, id).subscribe(function (data) {
            ...
            if (data.errorCode === 0) {
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3__shared_components_modal_modal_model__["c" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3__shared_components_modal_modal_model__["b" /* AlertType */].ERROR, 'IP映射', '修改失败');
                _this.modalService.alert(alertCfg);
            }
        });
    };
