...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_components_modal_modal_service__ = __webpack_require__("../../../../../src/app/shared/components/modal/modal.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_service__ = __webpack_require__("../../../../../src/app/app.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__switch_switch_model__ = __webpack_require__("../../../../../src/app/layout/my-component/components/switch/switch-model.ts");
...
var UserListComponent = (function () {
    ...
    function UserListComponent(appService, systemService, modalService) {
        this.appService = appService;
        this.systemService = systemService;
        this.modalService = modalService;
        this.theme = __WEBPACK_IMPORTED_MODULE_5__switch_switch_model__["a" /* SwitchTheme */].THTME_WARNING;
        this.theme2 = __WEBPACK_IMPORTED_MODULE_5__switch_switch_model__["a" /* SwitchTheme */].THTME_SUCCESS;
        this.header = '添加会员';
    ...
    UserListComponent.prototype.editMember = function (event, id) {
        ...
        this.systemService.updateMember(event.formModel.value, id).subscribe(function (data) {
            //console.log(data)
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["c" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["b" /* AlertType */].INFO, '会员管理', '修改成功');
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["c" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '会员管理', data.msg);
                _this.modalService.alert(alertCfg);
            }
        });
    };
    ...
    UserListComponent.prototype.addMember = function (event) {
        var _this = this;
        this.systemService.addMember(event.formModel.value).subscribe(function (data) {
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["c" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_2__shared_components_modal_modal_model__["b" /* AlertType */].INFO, '会员管理', '添加成功');
                _this.modalService.alert(alertCfg);
                event.ref.close();
                _this.appService.pageRefreshEventEmitter.emit(_this.transformPageData); //创建一个事件流发送传递过来的分页信息
            }
