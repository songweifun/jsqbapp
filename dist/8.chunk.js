...
var AddLibraryModalComponent = (function () {
    function AddLibraryModalComponent(modalService, systemService, modalService2, fb) {
        ...
        this.formModel = fb.group({
            app_id: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(6)]],
            secret: fb.group({
        ...
        if (this.ipMapId) {
            ...
            this.systemService.getOneLibrary(this.ipMapId).subscribe(function (data) {
                ...
                _this.formModel = _this.fb.group({
                    app_id: [data.app_id, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(6)]],
                    secret: _this.fb.group({
                        app_secret: [data.app_secret, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(6)],
                        c_app_secret: [data.app_secret]
                    }, {
                        validator: __WEBPACK_IMPORTED_MODULE_5__validator_validators__["a" /* equalValidator */] //这么用
                    }),
                    school_id: [data.school_id.id, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
...
var LibraryComponent = (function () {
    ...
    LibraryComponent.prototype.addLibrary = function (event) {
        ...
        this.systemService.addLibrary(event.formModel.value).subscribe(function (data) {
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, '成员馆管理', '添加成功');
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '成员馆管理', data.msg);
                _this.modalService.alert(alertCfg);
            }
        });
    };
    LibraryComponent.prototype.editLibray = function (event, id) {
        ...
        this.systemService.updateLibrary(event.formModel.value, id).subscribe(function (data) {
            //console.log(data)
            if (data.errorCode === 0) {
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, 'IP映射', '修改成功');
                _this.modalService.alert(alertCfg);
                event.ref.close();
                //this.appService.pageRefreshEventEmitter.emit(this.transformPageData);//创建一个事件流发送传递过来的分页信息
                _this.systemService.getLibrarys().subscribe(function (data) {
                ...
                var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, 'IP映射', '修改失败');
                _this.modalService.alert(alertCfg);
            }
        });
    };
    LibraryComponent.prototype.deleteLibrary = function (id) {
        var _this = this;
        var confirmCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["c" /* ConfirmConfig */]('您确定要删除此映射吗？');
        this.modalService.confirm(confirmCfg).then(function (result) {
            _this.systemService.deleteLibrary(id).subscribe(function (data) {
                if (data.errorCode === 0) {
                    var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].INFO, '成员馆管理', '删除成功');
                    _this.modalService.alert(alertCfg);
                    //this.appService.pageRefreshEventEmitter.emit(this.transformPageData);//创建一个事件流发送传递过来的分页信息
                    _this.systemService.getLibrarys().subscribe(function (data) {
                        _this.libraries = data;
                    ...
                    var alertCfg = new __WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["a" /* AlertConfig */](__WEBPACK_IMPORTED_MODULE_3_app_shared_components_modal_modal_model__["b" /* AlertType */].ERROR, '成员馆管理', '删除失败');
                    _this.modalService.alert(alertCfg);
                }
            });
        }, function (reason) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__system_component__ = __webpack_require__("../../../../../src/app/layout/system/system.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__system_routing_module__ = __webpack_require__("../../../../../src/app/layout/system/system-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__library_library_component__ = __webpack_require__("../../../../../src/app/layout/system/library/library.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_shared_module__ = __webpack_require__("../../../../../src/app/shared/shared.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__my_component_components_add_library_modal_add_library_modal_component__ = __webpack_require__("../../../../../src/app/layout/my-component/components/add-library-modal/add-library-modal.component.ts");
...
SystemModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__system_component__["a" /* SystemComponent */],
            __WEBPACK_IMPORTED_MODULE_4__library_library_component__["a" /* LibraryComponent */],
            __WEBPACK_IMPORTED_MODULE_6__my_component_components_add_library_modal_add_library_modal_component__["a" /* AddLibraryModalComponent */]
        ]
    })
], SystemModule);
